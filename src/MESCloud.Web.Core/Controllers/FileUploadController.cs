...
using MESCloud.WMS.BaseData.StorageLocations;
...
namespace MESCloud.Controllers
{
    ...
    public class FileUploadController : MESCloudControllerBase
    {
        readonly IRepository<BOM, string> _repository;
        readonly FileHelperService _fileHelperService;
        readonly IRepository<I18N, int> _repositoryI18N;
        ...
        public FileUploadController(IRepository<BOM, string> repository,
            ...
            IRepository<I18N, int> repositoryI18N)
        {
        ...
        async Task<List<I18N>> GetI18NByDtoName(String dtoName)
        {
            ...
            var dbI18N = await _repositoryI18N.GetAll().Where(i => i.ClassName == dtoName).ToListAsync();
            ...
            {
                cfg.CreateMap<System.Reflection.PropertyInfo, I18N>()
                    .ForMember(m => m.ClassName, opt => opt.MapFrom(s => dtoName))
                    .ForMember(m => m.PropertyName, opt => opt.MapFrom(s => s.Name))
            ...
            return config.CreateMapper().Map<List<System.Reflection.PropertyInfo>, List<I18N>>(p.ToList());
        }
    }
}
